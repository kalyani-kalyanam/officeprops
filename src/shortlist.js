...
<div className="col-md-12">
	<h5 className="my_title"><b>Shortlist Office Spaces</b></h5>
</div>
...
<div className="col-12 mb-20 mt-20">
                                    <Link to="/chat"><button type="submit" className="btn hami-btn select smallbtn btn-3">Chat<span className="badge badge-light">4</span></button></Link>
                                </div>
								
								<div className="col-12">
                                    <Link to="/selected"><button type="submit" className="btn hami-btn smallbtn btn-3">Select</button></Link>
                                </div>
...
<div className="col-md-3">
<div className="col-12 mb-20 mt-20">
                                    <Link to="/chat"><button type="submit" className="btn hami-btn select smallbtn btn-3">Chat<span className="badge badge-light">0</span></button></Link>
                                </div>
